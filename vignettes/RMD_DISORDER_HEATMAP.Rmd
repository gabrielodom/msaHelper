...
```{r, Importing-IUPRED-Results}
library(tidyverse)
results_char <- readLines(
  "../inst/extdata/data_raw/COMBINED_BLAST2_MUSCLE.result"
)
...
Results_File <- read_csv(
  "../inst/extdata/data_clean/muscle_BLAST2_results_20220420.csv"
)
